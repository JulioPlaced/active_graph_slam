...
(cl:in-package rrt_exploration-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <PointArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PointArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rrt_exploration-msg:<PointArray> is deprecated: use rrt_exploration-msg:PointArray instead.")))

(cl:ensure-generic-function 'points-val :lambda-list '(m))
(cl:defmethod points-val ((m <PointArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rrt_exploration-msg:points-val is deprecated.  Use rrt_exploration-msg:points instead.")
  (points m))
