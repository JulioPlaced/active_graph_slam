...
if(NOT "/home/julio/source/active_slam_project_github/devel/.private/graph_d_exploration/include " STREQUAL " ")
  set(graph_d_exploration_INCLUDE_DIRS "")
  set(_include_dirs "/home/julio/source/active_slam_project_github/devel/.private/graph_d_exploration/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'graph_d_exploration' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/julio/source/active_slam_project_github/src/d_opt_exploration/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/julio/source/active_slam_project_github/devel/.private/graph_d_exploration/lib;/home/julio/source/active_slam_project_github/devel/lib;/opt/ros/noetic/lib)
