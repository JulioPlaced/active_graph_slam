...
if("TRUE" STREQUAL "TRUE")
  set(open_karto_SOURCE_PREFIX /home/julio/source/active_slam_project_github/src/3dParty/open_karto)
  set(open_karto_DEVEL_PREFIX /home/julio/source/active_slam_project_github/devel/.private/open_karto)
  ...
  set(open_karto_INSTALL_PREFIX /home/julio/source/active_slam_project_github/install)
...
if(NOT "/home/julio/source/active_slam_project_github/src/3dParty/open_karto/include;/usr/include " STREQUAL " ")
  set(open_karto_INCLUDE_DIRS "")
  set(_include_dirs "/home/julio/source/active_slam_project_github/src/3dParty/open_karto/include;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'open_karto' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/julio/source/active_slam_project_github/src/3dParty/open_karto/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/julio/source/active_slam_project_github/devel/.private/open_karto/lib;/home/julio/source/active_slam_project_github/devel/lib;/opt/ros/noetic/lib)
